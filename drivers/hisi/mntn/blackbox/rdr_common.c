...
Description:	Ã¿ŽÎÒì³£¶ÔÓŠµÄlogÄ¿ÂŒ±£ŽæÍê±Ïºó£¬ÐèÒªµ÷ÓÃŽËº¯Êý±íÊŸÕâžöÄ¿ÂŒÒÑŸ­
		ŒÇÂŒÍê±ÏÁË£¬logserver¿ÉÒÔœ«ÆäŽò°üÉÏŽ«ÁË¡£
Input:	logpath:Òì³£¶ÔÓŠµÄ±£ŽælogµÄÄ¿ÂŒ£»
		step:Òì³£log±£ŽæµœÁËÄÄÒ»²œ£¬ÊÇ·ñ»¹ÐèÒªŒÌÐøÊ¹ÓÃµÄ±êŒÇ£»
Output:		    NA
Return:		    NA
...
void bbox_save_done(char *logpath, u32 step)
{
	...
	if (BBOX_SAVE_STEP_DONE == step) {
		...
		/*×éºÏdoneÎÄŒþµÄŸø¶ÔÂ·Ÿ¶£¬×÷Îªsys_mkdirµÄ²ÎÊý */
		...
		/*žùŸÝÈšÏÞÒªÇó£¬hisi_logsÄ¿ÂŒŒ°×ÓÄ¿ÂŒÈº×éµ÷ÕûÎªroot-system */
		ret =
